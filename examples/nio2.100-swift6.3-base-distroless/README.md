# SwiftNIO Server - Distroless

This directory contains a [SwiftNIO](https://opensource.apple.com/projects/swiftnio/) server running on Unikraft.
...
- The libraries `libm`, `glibc` and `libstdc++`
...
elastic_golden  oci://unikraft.org/base:latest  /server  13 seconds ago  running  256M  0.0.0.0:8080->8080/tcp  qemu/x86_64
```

The instance name is `elastic_golden`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm elastic_golden
```
