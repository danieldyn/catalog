# Go Fiber Web Server - Distroless

This directory contains a [`Fiber`](https://gofiber.io/) web server running on Unikraft.
...
magical_freud  oci://unikraft.org/base:latest  /server  5 seconds ago  running  256M  0.0.0.0:8080->8080/tcp  qemu/x86_64
```

The instance name is `magical_freud`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm magical_freud
```
