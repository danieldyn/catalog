...
festive_panbanisha  oci://unikraft.org/base:latest  /usr/local/bin/python3 /app/server.py  26 seconds ago  running  488M  0.0.0.0:8080->8080/tcp  qemu/x86_64
```

The instance name is `festive_panbanisha`.
To close the Unikraft instance, close the `kraft` process (e.g., via `Ctrl+c`) or run:

```bash
kraft rm festive_panbanisha
```
